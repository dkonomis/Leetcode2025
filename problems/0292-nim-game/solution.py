class Solution:
    def canWinNim(self, n: int) -> bool:
        ...
        Key insight: If there are 4 stones, the first player always loses because
        no matter how many stones they take (1, 2, or 3), the opponent can always
        take the remaining stones. This pattern repeats for all multiples of 4.
